...
var fetchStudentData = () => {
    var endpoint = 'https://v0iznmrwwf.execute-api.us-east-1.amazonaws.com/student-api/getStudent';
...
var addStudent = (rollNumber, studentName, className) => {
    ...
    var endpoint = 'https://v0iznmrwwf.execute-api.us-east-1.amazonaws.com/student-api/addStudent';
